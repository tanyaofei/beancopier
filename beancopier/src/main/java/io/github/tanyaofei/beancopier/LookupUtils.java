...
public class LookupUtils {
  ...
  public static <C extends ClassLoader> MethodHandles.Lookup lookupInClassLoader(
      ...
      @NotNull QuintFunction<C, String, byte[], Integer, Integer, Class<?>> defineClass
      // classLoader, name, code, offset, length
  ) {
  ...
  public static <C extends ClassLoader> MethodHandles.Lookup lookupInClassLoader(
    ...
    return lookupInClassLoader(classLoader, (cl, __, code, ___, ____) -> defineClass.apply(cl, code));
  }
